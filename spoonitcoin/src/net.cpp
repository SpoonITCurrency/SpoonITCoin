...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "SpoonITCoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"spoonitcointools.com", "dnsseed.spoonitcointools.com"},
    {"spoonitcoinpool.org", "dnsseed.spoonitcoinpool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"spoonitcointools.com", "testnet-seed.spoonitcointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. SpoonITCoin is probably already running."), addrBind.ToString().c_str());
        else
